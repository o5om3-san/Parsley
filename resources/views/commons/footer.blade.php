        ...
        <div class="container">
            <div class="footer-header">
                ...
                <ul class="nav navbar-nav navbar-left">
                    @if (Auth::check())
                        <li>{!! link_to_route('users.show','ホーム',['id' => Auth::id()],['class' => 'fas fa-home fa-lg fa-spin']) !!}</li>
                        <li>{!! link_to_route('otsukais.create','買い物に行く',null,['class' => 'fas fa-shopping-cart fa-lg fa-spin']) !!}</li>
